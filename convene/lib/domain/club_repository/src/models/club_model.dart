...
abstract class ClubModel implements _$ClubModel {
  ...
  factory ClubModel.fromDocumentSnapshot(DocumentSnapshot documentSnapshot) {
    return ClubModel(
      ...
      leader: documentSnapshot.data() != null ? documentSnapshot.data()!["leader"] as String : "Error no leader",
      nextIndexPicking: documentSnapshot.data() != null ? documentSnapshot.data()!["nextIndexPicking"] as int : 0,
      ...
      notifTokens: (documentSnapshot.data()?["notifTokens"] != null)
          ...
          : <String>[],
      dateCreated:
          (documentSnapshot.data() != null ? documentSnapshot.data()!["dateCreated"] as Timestamp : Timestamp.fromDate(DateTime(1)))
              .toDate(),
      currentBookId: documentSnapshot.data() != null ? documentSnapshot.data()!["currentBookId"] as String : "Error no current bok",
      currentBookDue:
          (documentSnapshot.data() != null ? documentSnapshot.data()!["currentBookDue"] as Timestamp : Timestamp.fromDate(DateTime(1)))
              .toDate(),
      nextBookId: documentSnapshot.data() != null ? documentSnapshot.data()!["nextBookId"] as String : "no id",
      nextBookDue:
          (documentSnapshot.data() != null ? documentSnapshot.data()!["nextBookDue"] as Timestamp : Timestamp.fromDate(DateTime(1)))
              .toDate(),
    );
  }
